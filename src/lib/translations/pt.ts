export const pt = {
  ...
  Footer: {
    rights: "3V Capital © Todos os direitos reservados.",
    address: "Endereço",
    contact: "Contato", 
  ...
  NewsPage: {
    ...
    intro: {
      title: "Na Mídia",
      subtitle: "Acompanhe as publicações e participações da 3V Capital na mídia."
    }
  },
  OQueFazemosPage: {
    hero: {
    ...
    intro: {
      fullText: "Gerimos o patrimônio de nossos clientes, sendo parceiros no entendimento de suas necessidades e das circunstâncias que os cercam ao longo da vida, buscando a preservação e o crescimento do seu patrimônio.",
...
ContactPage: {
 ...
 CartasMensaisPage: {
    hero: {
      title: 'Cartas Mensais'
    },
    intro: {
      title: 'Cartas Mensais',
      subtitle: 'Acesse todo o histórico de cartas mensais da 3V Capital.'
    },
    featured: {
      badge: 'Carta do Mês',
      openPdf: 'Abrir PDF', 
    ...
    filters: {
      ...
      lettersFound: 'cartas encontradas',
      clearFilters: 'Limpar Filtros',
      yearLabel: 'Filtrar por Ano',
      monthLabel: 'Filtrar por Mês',
      filterByTags: 'Filtrar por Tópicos',
      clearAll: 'Limpar Todos',
      title: 'Filtrar Cartas'
    },
    calendar: {
      noLetters: 'Nenhuma carta disponível para este ano.',
      pages: 'páginas',
      openPdf: 'Abrir PDF',
    ...
    viewMode: {
      ...
      timeline: { // Adicione esta seção
      openPdf: "Visualizar PDF",
      fileSize: "PDF • "
    },
  },
  CompliancePage: {
